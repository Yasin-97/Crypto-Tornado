...
import {usePagination} from "helpers/customHook";
import { screen,renderWithRedux } from "helpers/testUtilities/testUtils";
import {testingCoins} from 'helpers/testUtilities/testingData'

jest.mock("store/apis/cryptoApi", () => ({useGetCryptosQuery: jest.fn()}));
jest.mock("helpers/customHook/usePagination");
